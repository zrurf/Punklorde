/// 畅课 API 端点（各校路径一致，仅基地址不同）
class TronclassEndpoints {
  final String baseUrl;

  const TronclassEndpoints(this.baseUrl);

  String get apiGetEvent => "$baseUrl/api/radar/rollcalls?api_version=1.1.0"; // 获取签到事件
