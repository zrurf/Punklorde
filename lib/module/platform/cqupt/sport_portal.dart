...
const String _domain = "172.20.2.228";
const String _baseUrl = "http://$_domain";
const String _domainLogin = "$_baseUrl/portal/pages/casLogin/index";
const String _apiLogin = "$_baseUrl/api/oauth/fs/sys/login";
const String _apiInfo = "$_baseUrl/api/oauth/getUserInfo";
